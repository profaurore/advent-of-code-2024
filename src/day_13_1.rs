...
pub fn day_13_1() {
    ...
    // a + b <= 100
    let total_tokens = games.iter().fold(0f32, |sum, game| {
        let Game {
            button_a,
            button_b,
            prize,
        ...
        let tokens = if b == b.round() && a <= 100. && b <= 100. {
            a * COST_A + b * COST_B
        } else {
            0.
        };
